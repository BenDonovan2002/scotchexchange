...
function CheckIfBottleExists(bottleModel) {
...
function InsertBottleModel(bottleModel) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            let connection = mysql.createConnection(info_mysql.getSQL());
            connection.connect((err) => {
...
function __run__() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < bottleModels.length; i++) {
            ...
            let exists = yield CheckIfBottleExists(bottleModels[i]);
            if (!exists) {
                let results = yield InsertBottleModel(bottleModels[i]);
                console.log(results);
            }
            else {
                console.log("exists");
