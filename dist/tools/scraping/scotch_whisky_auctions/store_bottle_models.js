...
function __main__() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 225506; i < x.length; i++) {
            ...
            let distillery = yield GetDistillery(x[i]);
            let size = yield GetBottleSize(x[i]);
            let age = yield GetBottleAge(x[i]);
            let ABV = yield GetBottleABV(x[i]);
            try {
                bottleInfoObject = {
